...
\title{Ray-Tracing Based RIS Design and Optimization for Indoor Coverage Enhancement}
...
\begin{itemize}
	...
	\item Many papers use simplified channel models with certain assumptions, overlooking the realistic characterization of an environment and failing to account for both LoS and non-LoS (NLoS) paths. Most studies assume only LoS path consideration, disregarding strong NLoS paths.
\end{itemize}
