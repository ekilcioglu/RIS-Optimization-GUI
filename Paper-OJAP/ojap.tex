...
\begin{figure}
	...
	\begin{minipage}[b]{0.47\linewidth}
		\includegraphics[width=\textwidth]{Sim_Results/Binary_Cov_Map_N_2_-100dB.png}
		\caption{N = 2}
		\label{fig:first}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.47\linewidth}
		\includegraphics[width=\textwidth]{Sim_Results/Binary_Cov_Map_N_3_-100dB.png}
		\caption{N = 3}
		\label{fig:second}
	\end{minipage}\\[10pt]
	\begin{minipage}[b]{0.47\linewidth}
		\includegraphics[width=\textwidth]{Sim_Results/Binary_Cov_Map_N_4_-100dB.png}
		\caption{N = 4}
		\label{fig:third}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.47\linewidth}
		\includegraphics[width=\textwidth]{Sim_Results/Binary_Cov_Map_N_5_-100dB.png}
		\caption{N = 5}
		\label{fig:fourth}
	\end{minipage}
...
\begin{figure*}
	\centering \includegraphics[width=.7\linewidth]{Sim_Results/multiple_curves_perf_metric_vs_RIS_width.png}
	\caption{aa}
	\label{aa}
\end{figure*}
